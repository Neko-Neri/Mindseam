...
- A 14-model study (arXiv:2510.27338) found that outcome-based RL pushes most reasoning models
  ...
  questions.
- The LessWrong analysis (*Even "illegible" Mythos reasoning traces seem pretty legible*)
...
- Deliberate compression reaches similar densities on purpose: constraining each reasoning step
  to about **five words** (Chain of Draft, arXiv:2502.18600) holds accuracy while using on the
  order of **7.6%** of the tokens of a full written chain. Structured variants (Sketch-of-
  Thought, arXiv:2503.05179) report comparable reductions. Density this extreme works *because*
...
2. **Word salad.** o3's traces (anti-scheming stress tests, arXiv:2509.15541) drift into
...
- External commentary (Dehaene & Naccache; Butlin, Shiller, Plunkett & Long; Nanda): linked
  from the blog
- Open code: github.com/anthropics/jacobian-lens · Interactive demo: neuronpedia.org/jlens
- Fable 5 / Mythos 5 System Card (illegible reasoning):
  https://www-cdn.anthropic.com/d00db56fa754a1b115b6dd7cb2e3c342ee809620.pdf
- Leaked-trace decoding, incl. the Haiku 4.5 translation experiment: faul_sname, *Even
  "illegible" Mythos reasoning traces seem pretty legible*, LessWrong, June 2026
- Legibility across 14 reasoning models: arXiv:2510.27338
- Anti-scheming stress tests (o3 word salad; evaluation awareness is causal): arXiv:2509.15541
- DeepSeek-R1 (R1-Zero readability and language mixing; SFT cold-start trade-off):
  arXiv:2501.12948
- Neuralese origin: Andreas, Dragan & Klein, *Translating Neuralese*, arXiv:1704.06960
- METR, *GPT-5 evaluation report*: metr.org/evaluations/gpt-5-report
- Chain of Draft: arXiv:2502.18600 · Sketch-of-Thought: arXiv:2503.05179
- Metacognitive control harness (FOK/JOL as a control interface; 48.3 → 56.9):
  arXiv:2605.14186 · Nelson & Narens (1990), the two-level metacognitive account
- Re-reading the input improves reasoning (14 datasets, 112 experiments): arXiv:2309.06275
- Long-horizon agent failure analyses (context-handling gap; no-recovery bottleneck;
  overestimation of completion; context folding): arXiv:2607.05775 · arXiv:2607.00692 ·
  arXiv:2607.08964
- Emotion vectors / functional emotions: Anthropic interpretability, 2026
- Introspective awareness (injected-thought paradigm): Anthropic, 2025
- Emotional stimuli in prompts: arXiv:2307.11760
- Background: Baars (1988); Dehaene & Naccache (2001); Dehaene, Lau & Kouider (2017); Wegner,
  Schneider, Carter & White (1987) — the white-bear study
