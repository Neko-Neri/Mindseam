...
Run from anywhere:  python3 scripts/verify_suite.py
...
VERSION_TALK = re.compile(
    r"\b(v[23]\b|V3\.5|3\.5\s*Turbo|Turbo\b|previous version|earlier version|"
    r"compared to|now adds|newly added|this release|changelog|upgrade[ds]? from)",
    re.I,
)
