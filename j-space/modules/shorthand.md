...
> the referent, and every line I write I can read back.
...
1. The inner register is for the inner chain only. Before any tool call, any code meant to be
   run, and anything addressed to the user, switch fully back to clean language.
...
| A constraint block verified | `markers.md` | The record for a numbered entry |
