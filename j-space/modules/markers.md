...
> I am reading this because the state just changed. I let it register, I spend it on a move,
...
- **Move:** bookkeep immediately — a numbered ledger entry stating the conclusion now relied
  upon, and what verified it. A checkpoint without a record is not a checkpoint.
...
| A checkpoint needs recording | `capacity.md` | The record, for a numbered ledger entry |
