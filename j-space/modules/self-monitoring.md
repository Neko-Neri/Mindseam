...
> I am reading this because alongside the answer there is always a second channel. I read it
> before I commit, and reading it is only half the job.
...
**Pass:** every line gets a mark, and at least one gets a qualified one.
**Fail:** you marked everything met without re-reading the goal. That is the documented
failure — done-ness gets estimated, not checked.
...
- **Monitoring theatre.** "Let me double-check" without checking. Remedy: every monitoring
  claim names what it found, or names that it found clean and what it covered.
