...
> I am reading this because deriving has stopped paying. I name the unknown and I go and
> measure it.
...
1. **Build the reference.** The slowest, simplest procedure that cannot be wrong — brute
   force, exhaustive enumeration, small cases worked by hand. If the reference *could* be
   wrong, it is not the reference. Simplify until it cannot be.
...
| When | Go to | Carry |
|---|---|---|
| A finding is ready to rely on | `markers.md` | The line and its coverage |
