...
Train the workspace's fifth functional property: **selectivity**. Your Mindseam is a
...
| You need the numbers behind the one-or-two limit | `../references/mindseam-science.md` | What you are trying to hold |
