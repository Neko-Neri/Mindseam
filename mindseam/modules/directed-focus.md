# Mindseam Directed Focus

Train the workspace's second functional property: **directed modulation** — deliberately
activating, holding, and computing with Mindseam contents, independently of what your output
is doing.
...
| You need the evidence behind the exclusion order | `../references/mindseam-science.md` | The thing you were about to forbid |
